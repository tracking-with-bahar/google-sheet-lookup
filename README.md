...
Add the provided [Apps Script](https://github.com/tracking-with-bahar/google-sheet-lookup/blob/main/appscript.js) file to your Google Sheet's Apps Script editor. Then update the googleSheetId and googleSheetName variables.
